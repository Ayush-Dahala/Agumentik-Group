                                ...
                                <div className="col-md-5 col-sm-6">
                                    <div className="p-b0">
                                        <div className="mt-box">
                                            <h3 className="m-t0"><span className="font-weight-100"> We have</span><span className="text-primary"> 15 years</span> experience in industry with leading Brands</h3>
                                        </div>
                                        <span className="progressText text-black"><b>Business Growth </b></span>
                                        ...
                                        <span className="progressText text-black"><b>Branches</b></span>
                                        <div className="progress mt-probar-1 m-b30 m-t10">
                                        ...
                                        <span className="progressText text-black"><b>Employee</b></span>
                                        <div className="progress mt-probar-1 m-b30 m-t10">
                                        ...
                                        <span className="progressText text-black"><b>Branding
                                        </b></span>
                                        <div className="progress mt-probar-1 m-b30 m-t10">
